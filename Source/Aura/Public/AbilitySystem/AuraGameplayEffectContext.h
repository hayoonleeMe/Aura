...
public:
	FAuraGameplayEffectContext()
		: bIsBlockedHit(false), bCanBlockedHit(true), bIsCriticalHit(false), bCanCriticalHit(true), bShouldActivateHitReact(true), DebuffChance(0.f), DebuffDuration(0.f)
	{}
